...
$config['mongo_db']['default']['hostname'] = 'androidcru-ian.jonamireh.com';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'matt';
$config['mongo_db']['default']['password'] = 'matt';
$config['mongo_db']['default']['database'] = 'slocru';
